...
class JulesPftparm(NamelistModel):
    ...
    canht_ft_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """The height of each PFT (m), also known as the canopy height."""
    lai_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """The leaf area index (LAI) of each PFT."""
    c3_io: Annotated[list[SentinelOrZeroOne] | None, ListLen("npft")] = None
    """Flag indicating whether PFT is C3 type."""
    orient_io: Annotated[list[SentinelOrZeroOne] | None, ListLen("npft")] = None
    ...
    albsnc_max_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Snow-covered albedo for large leaf area index."""
    albsnc_min_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Snow-covered albedo for zero leaf area index."""
    albsnf_max_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Snow-free albedo for large LAI."""
    albsnf_maxu_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Upper bound for snow-free albedo for large LAI when scaled."""
    albsnf_maxl_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Lower bound for snow-free albedo for large LAI when scaled."""
    alnir_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Leaf reflection coefficient for NIR."""
    alpar_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Leaf reflection coefficient for VIS (photosynthetically active radiation)."""
    alpha_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    ...
    catch0_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    ...
    dqcrit_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    ...
    emis_pft_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Surface emissivity of vegetated surfaces."""
    eta_sl_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Live stemwood coefficient (kg C/m/(m2 leaf))."""
    f0_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """CI / CA for DQ = 0."""
    fd_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    ...
    fsmc_of_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Moisture availability below which leaves are dropped."""
    fsmc_p0_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """PFT-dependent water stress threshold parameter."""
    g_leaf_0_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Minimum turnover rate for leaves (/360days)."""
    glmin_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Minimum leaf conductance for H2O."""
    gsoil_f_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Soil conductance enhancement factor."""
    hw_sw_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Ratio of N stem to N heartwood (kgN/kgN)."""
    infil_f_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Infiltration enhancement factor."""
    kext_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Light extinction coefficient for Beer's Law."""
    kn_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Parameter for decay of nitrogen through canopy by layers."""
    knl_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Parameter for decay of nitrogen through canopy by LAI."""
    kpar_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """PAR Extinction coefficient."""
    lai_alb_lim_io: Annotated[list[SentinelOrNonNegFloat], ListLen("npft")] | None = (
        None
    )
    """Minimum LAI in albedo calculation without snow."""
    lma_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Leaf mass per unit area."""
    neff_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Scale factor relating Vcmax with leaf nitrogen concentration."""
    nl0_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Top leaf nitrogen concentration (kg N/kg C)."""
    nmass_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Top leaf nitrogen content per unit mass."""
    nr_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Root nitrogen concentration (kgN/kgC)."""
    nr_nl_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Ratio of root nitrogen to leaf nitrogen concentration."""
    ns_nl_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Ratio of stem nitrogen to leaf nitrogen concentration."""
    nsw_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Stemwood nitrogen concentration (kgN/kgC)."""
    omega_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Leaf scattering coefficient for PAR."""
    omnir_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Leaf scattering coefficient for NIR."""
    q10_leaf_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Q10 factor for plant respiration."""
    r_grow_io: Annotated[list[SentinelOrFraction] | None, ListLen("npft")] = None
    """Growth respiration fraction."""
    rootd_ft_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    """Parameter determining root depth (m)."""
    sigl_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
    ...
    z0hm_classic_pft_io: (
        Annotated[list[SentinelOrNonNegFloat], ListLen("npft")] | None
    ) = None
    """Roughness length ratio for heat/momentum for CLASSIC."""
    z0hm_pft_io: Annotated[list[SentinelOrNonNegFloat] | None, ListLen("npft")] = None
