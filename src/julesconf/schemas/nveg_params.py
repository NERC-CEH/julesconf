...
class JulesNvegparm(NamelistModel):
    ...
    """Snow-free albedo."""
    albsnf_nvgu_io: Annotated[list[Fraction] | None, ListLen("nnvg")] = None
    """Upper limit on snow-free albedo when l_albedo_obs = TRUE."""
    albsnf_nvgl_io: Annotated[list[Fraction] | None, ListLen("nnvg")] = None
    """Lower limit on snow-free albedo when l_albedo_obs = TRUE."""
    catch_nvg_io: Annotated[list[NonNegFloat] | None, ListLen("nnvg")] = None
    """Capacity for water (kg m⁻²)."""
    gs_nvg_io: Annotated[list[NonNegFloat] | None, ListLen("nnvg")] = None
    """Surface conductance (m s⁻¹)."""
    infil_nvg_io: Annotated[list[NonNegFloat] | None, ListLen("nnvg")] = None
    """Infiltration enhancement factor."""
    z0_nvg_io: Annotated[list[NonNegFloat] | None, ListLen("nnvg")] = None
    """Roughness length for momentum (m)."""
    ch_nvg_io: Annotated[list[NonNegFloat] | None, ListLen("nnvg")] = None
    """Heat capacity of this surface type (J K⁻¹ m⁻²)."""
    vf_nvg_io: Annotated[list[Fraction] | None, ListLen("nnvg")] = None
    """Fractional coverage of non-vegetation canopy."""
    emis_nvg_io: Annotated[list[Fraction] | None, ListLen("nnvg")] = None
